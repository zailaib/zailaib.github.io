...
export const PART_DEFS = [
  ...
  { name: 'floor',       label: '一层地板',   color: '#908878', deps: ['wallFront','wallBack','wallLeft','wallRight'], cat: 'base' },
  ...
  { name: 'interiorWalls', label: '一层内隔墙', color: '#ede6d8', deps: [], cat: 'structure' },
  ...
  { name: 'upperInteriorWalls', label: '二层内隔墙', color: '#ede6d8', deps: [], cat: 'structure' },
  // Roof
  ...
  { name: 'screen',      label: '屏风',       color: '#8b6914', deps: [], cat: 'openings' },
  // 1F rooms
  { name: 'elderRoom',   label: '老人房',     color: '#7a4a20', deps: ['wallLeft'], cat: 'interior' },
  { name: 'secondBed1F', label: '次卧(一层)', color: '#7a4a20', deps: [], cat: 'interior' },
  { name: 'mainHall',    label: '堂屋',       color: '#8b6914', deps: [], cat: 'interior' },
  { name: 'storage1F',   label: '储藏',       color: '#8b6914', deps: ['wallRight'], cat: 'interior' },
  { name: 'study1F',     label: '书房',       color: '#8b6914', deps: ['wallLeft'], cat: 'interior' },
  { name: 'bathroom1F',  label: '一层卫生间', color: '#c8d8e8', deps: ['interiorWalls','wallBack'], cat: 'interior' },
  { name: 'kitchen',     label: '厨房',       color: '#8b5a3a', deps: [], cat: 'interior' },
  { name: 'diningRoom',  label: '餐厅',       color: '#8b6914', deps: ['wallRight'], cat: 'interior' },
  // 2F rooms
  { name: 'childRoom1',  label: '儿童房1',    color: '#7a4a20', deps: ['upperWallLeft'], cat: 'interior' },
  { name: 'secondBed2F', label: '次卧(二层)', color: '#7a4a20', deps: [], cat: 'interior' },
  { name: 'masterBed',   label: '主卧',       color: '#7a4a20', deps: [], cat: 'interior' },
  { name: 'storage2F',   label: '杂物间',     color: '#8b6914', deps: ['upperWallRight'], cat: 'interior' },
  { name: 'childRoom2',  label: '儿童房2',    color: '#7a4a20', deps: ['upperWallLeft'], cat: 'interior' },
  { name: 'bathroom2F',  label: '二层卫生间', color: '#c8d8e8', deps: ['upperInteriorWalls','upperWallBack'], cat: 'interior' },
  { name: 'living2F',    label: '起居厅',     color: '#8b6914', deps: [], cat: 'interior' },
  // Plumbing
