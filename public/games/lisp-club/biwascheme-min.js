/*
 * BiwaScheme 0.8.3 - R6RS/R7RS Scheme in JavaScript
 *
 * Copyright (c) 2007-2025 Yutaka HARA (http://www.biwascheme.org/)
...
!(function (e, t) {
  ...
  var S =
    ...
    (function (e) {
      ...
      try {
        A.apply((B = L.call(w.childNodes)), w.childNodes),
      ...
      function oe(e, t, r, i) {
        ...
        if (!i && (d(t), (t = t || p), m)) {
          ...
          if (
            ...
            if (((g = e), (b = t), 1 === w && (z.test(e) || U.test(e)))) {
              for (
            ...
            return 1 === r && 0 === i
              ...
              : function (t, n, u) {
                  ...
                  if (_) {
                    ...
                    if (((h = [s ? _.firstChild : _.lastChild]), s && b)) {
                      for (
                        y =
                          (p =
                            (c =
        ...
        return (
          ...
          ce(function (a, s, o, u) {
            var c,
              ...
              g = n ? (i || (a ? e : h || r) ? [] : s) : _;
            if ((n && n(_, g, o, u), r))
              for (c = xe(g, p), r(c, [], o, u), l = c.length; l--; )
                (f = c[l]) && (g[p[l]] = !(_[p[l]] = f));
            if (a) {
              if (i || e) {
                if (i) {
            ...
            } else (g = xe(g === s ? g.splice(h, g.length) : g)), i ? i(null, s, g, u) : A.apply(s, g);
          })
        );
      }
      function Ce(e) {
      ...
      return (
                ...
                var n = t.length > 0,
                  ...
                  a = function (a, s, o, u, l) {
                    ...
                    for (
                      ...
                      if (i && f) {
                        for (
                          h = 0, s || f.ownerDocument == p || (d(f), (o = !m));
                          (_ = e[h++]);
        ...
        (u = oe.select = function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === p.length)) {
            ...
            for (
              a = X.needsContext.test(e) ? 0 : u.length;
    ...
    w.extend({
      ...
      ready: function (e) {
        (!0 === e ? --w.readyWait : w.isReady) ||
          ((w.isReady = !0),
          (!0 !== e && --w.readyWait > 0) || M.resolveWith(_, [w]));
      },
    }),
    (w.ready.then = M.then),
    ...
    w.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = Y.get(a)), 1 === a.nodeType && !G.get(a, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
    ...
    for (var n, r, i = [], a = 0, s = e.length; a < s; a++)
      (r = e[a]).style &&
        ...
        t
          ...
          : "none" !== n && ((i[a] = "none"), G.set(r, "display", n)));
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (r = n(this, t)),
                this[t](),
                s !== (a = G.get(this, t)) || r ? G.set(this, t, !1) : (a = {}),
                s !== a)
              )
                return (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, "input") && Pe(t, "click", xe),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, "input") && Pe(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Ae(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      Y.hasData(e) && ((a = Y.access(e)), (s = w.extend({}, a)), Y.set(t, s));
    }
  }
  function Le(e, t) {
    var n = t.nodeName.toLowerCase();
  ...
  function Ne(e, t, n, r) {
    ...
    var i,
      ...
      _ = t[0],
      g = h(_);
    if (g || (d > 1 && "string" == typeof _ && !p.checkClone && Te.test(_)))
      ...
      function (e, t, n) {
        ...
        t))
          if (((i = t[r]), rt.test(i))) {
            ...
            p[r] = (_ && _[r]) || w.style(e, r);
          }
        if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(p))
          for (r in (f &&
            1 === e.nodeType &&
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]),
            null == (c = _ && _.display) && (c = G.get(e, "display")),
          ...
          p))
            u ||
              (_
                ...
                : (_ = G.access(e, "fxshow", { display: c })),
              a && (_.hidden = !m),
              m && le([e], !0),
              d.done(function () {
                for (r in (m || le([e]), G.remove(e, "fxshow"), p))
                  w.style(e, r, p[r]);
              })),
              (u = ut(m ? _[r] : 0, r, d)),
              r in _ ||
      ...
      if (
        ...
        for (a = 0; (s = g[a++]) && !t.isPropagationStopped(); )
          (p = s),
            ...
            (f =
              (G.get(s, "events") || Object.create(null))[t.type] &&
              G.get(s, "handle")) && f.apply(s, n),
            (f = c && s[c]) &&
              f.apply &&
              Q(s) &&
        ...
        return (
          ...
          i ||
            ...
            (c &&
              ...
              ((o = r[c]) && (r[c] = null),
              (w.event.triggered = b),
              t.isPropagationStopped() && p.addEventListener(b, yt),
              r[b](),
              t.isPropagationStopped() && p.removeEventListener(b, yt),
      ...
      ajax: function (t, n) {
        ...
        p.hasContent
          ? p.data &&
            ...
            (p.data = p.data.replace(Tt, "+"))
          : ((d = p.url.slice(i.length)),
            p.data &&
              (p.processData || "string" == typeof p.data) &&
              ((i += (xt.test(i) ? "&" : "?") + p.data), delete p.data),
            !1 === p.cache &&
              ((i = i.replace(Bt, "$1")),
  ...
  w.ajaxSetup({
    ...
    (w.fn.load = function (e, t, n) {
      var r,
        ...
        o = e.indexOf(" ");
      return (
        o > -1 && ((r = ht(e.slice(o))), (e = e.slice(0, o))),
        h(t)
          ? ((n = t), (t = void 0))
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = Fe(p.pixelPosition, function (e, n) {
        if (n)
          return (n = He(e, t)), $e.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
...
var BiwaScheme = (function () {
  ...
  const max_trace_size = 40,
    ...
    VERSION = "0.8.3",
    GitCommit = "c52385d0ca3aa4dc58ec3b4a78c9651701a29530";
  var idCounter = 0;
  function uniqueId(e) {
    var t = ++idCounter + "";
    return e ? e + t : t;
  ...
  class BiwaError extends Error {
    constructor(e, t = null) {
      super(`${e}${null === t ? "" : `: ${to_write(t)}`}`), (this.form = t);
    }
    toString() {
      return this.message;
    }
  ...
  class Pair {
    ...
    async eachAsync(e) {
      for (var t = this; t instanceof Pair; t = t.cdr) await e(t.car);
      return t;
    }
    map(e) {
  ...
  const isPair = function (e) {
    ...
    inspect = function (e, t) {
      try {
        ...
        if (!0 === e) return "#t";
        if (!1 === e) return "#f";
        if (e.inspect) return e.inspect();
        if ("string" == typeof e) return '"' + e.replace(/"/g, '\\"') + '"';
        if (Array.isArray(e)) return "[" + e.map(inspect).join(", ") + "]";
        if (e instanceof Map) {
          var n = "#<Map";
          for (const [r, i] of e) n += ` ${inspect(r, t)}: ${inspect(i, t)}`;
          return n + ">";
        }
        return t && t.fallback ? t.fallback : e.toString();
      } catch (e) {
  ...
  class Compiler {
    ...
    _compile_lambda(e, t, n, r, i) {
      ...
      let u;
      u =
        isPair(o) && isSymbol(o.car) && "letrec*" == o.car.name
          ? Compiler.expand(o)
          : new Pair(Sym("begin"), e.cdr.cdr);
      var c = this.find_dot_pos(a),
        l = this.dotted2proper(a),
        f = this.find_free(u, to_set(l), r),
        d = this.find_sets(u, to_set(l));
      const p = n.set_minus(to_set(l)),
        h = d.set_union(p.set_intersect(f));
      var m = this.compile(u, [to_set(l), f], h, r.set_union(to_set(l)), [
          "return",
        ]),
        _ = [
          "close",
          ...
          f.size(),
          this.make_boxes(d, l, m),
          i,
          c,
        ];
      return this.collect_free(f, t, _);
    }
    run(e) {
  ...
  const make_assert = function (e) {
    ...
    make_simple_assert = function (e, t, n) {
      return make_assert(function (n, r, i) {
        const a = i ? "(" + i + "): " : "";
        if (!t(r))
          throw new BiwaError(a + e + " required, but got " + to_write(r));
      });
    };
  class Hashtable {
    constructor(e, t, n) {
  ...
  const ID_REXP = /^[^\s\t\n\(\)\[\]\{\}\"\'\`\,\;\|]+/,
    DIGITS = { 2: /^[01]+/, 8: /^[0-7]+/, 10: /^[0-9]+/, 16: /^[0-9a-fA-F]+/ },
    PAREN = { "(": ")", "{": "}", "[": "]" },
    NAMED_CHARS = {
      alarm: "",
      backspace: "\b",
  ...
  class Parser {
    ...
    getObject() {
      ...
      if ((this._skipAtmosphere(), this.done())) e = Parser.EOS;
        ...
        switch (t) {
          ...
          case "]":
          case "}":
            throw new Unbalanced(`found extraneous '${t}'`);
          case "'":
            e = this._parseQuote("quote");
            break;
          case "`":
            e = this._parseQuote("quasiquote");
            break;
          case ",":
            e = this._parseQuote("unquote");
            break;
          case ",@":
            e = this._parseQuote("unquote-splicing");
            break;
          default:
            e =
              "#" == t[0]
                ? this._parseSharp(t)
                : this._parseDecimalNumberOrIdentifier(t);
        }
      }
      return e;
    }
    ...
    _getToken() {
      ...
      switch (e) {
        ...
        case ",":
          this.i++,
            "@" == this.txt[this.i] ? (this.i++, (t = ",@")) : (t = ",");
          break;
        case "#":
          this.i++, (t = this._getSharpToken());
          break;
        default:
          const n = this.match(ID_REXP);
          n ? ((this.i += n[0].length), (t = n[0])) : (this.i++, (t = e));
      }
      return t;
    }
    _getSharpToken() {
      ...
      if (void 0 === e) return "#";
      if ("(" === e) return this.i++, "#(";
      if ("\\" === e) return this.i++, "#\\" + this._getCharToken();
      let t = this.match(/^(\d+)[=#]/);
      return t
        ? ((this.i += t[0].length), "#" + t[0])
        : ((t = this.match(ID_REXP)),
          t ? ((this.i += t[0].length), "#" + t[0]) : (this.i++, "#" + e));
    }
    _getCharToken() {
      if (this.done())
        throw new Unterminated("got EOS on char literal", this.rest(-2));
      const e = this.match(/^(\w+)/);
      if (e) return (this.i += e[0].length), e[0];
      {
        const e = this.txt[this.i];
        return this.i++, e;
      }
    ...
    _parseSharp(e) {
      if (!e.startsWith("#")) throw new Bug("not a sharp");
      switch (e) {
        case "#t":
        case "#true":
          return !0;
        ...
        default:
          switch (!0) {
            case e.startsWith("#\\"):
              return this._parseChar(e);
            case e.startsWith("#u8"):
              throw new BiwaError(
                "bytevectors are not supported yet",
                this.rest(-1)
              );
            case /^#[eibodx]/.test(e):
              return this._parsePrefixedNumber(e);
            case /^#\d/.test(e):
              return this._parseDatumLabel(e);
            default:
              throw new Invalid("unknown #-syntax", e);
          }
      }
    }
    _parseChar(e) {
      if (!e.startsWith("#\\")) throw new Bug("not a char");
      const t = e.substring(2);
      let n = NAMED_CHARS[t];
      if (n) return Char.get(n);
      let r = /^x([a-zA-Z0-9]+)$/.exec(t);
      if (r) return Char.get(String.fromCharCode(parseInt(r[1], 16)));
      if (1 == t.length) return Char.get(t);
      throw new Invalid(`Invalid char literal: ${e}`);
    }
    _parseVector() {
      this.i;
      const e = [];
    ...
    _parsePrefixedNumber(e) {
      let t = 10,
        n = e;
      n.match(/^#[iIeE]/) && (n = n.substring(2)),
        n.match(/^#[bB]/)
          ? ((t = 2), (n = n.substring(2)))
          : n.match(/^#[oO]/)
          ? ((t = 8), (n = n.substring(2)))
          : n.match(/^#[dD]/)
          ? ((t = 10), (n = n.substring(2)))
          : n.match(/^#[xX]/) && ((t = 16), (n = n.substring(2))),
        n.match(/^#[iIeE]/) && (n = n.substring(2));
      const r = this._parseComplexNumber(t, n);
      if (null === r) throw new Invalid("invalid number format: %{tok}");
      return r;
    }
    _parseComplexNumber(e, t) {
      const [n, r] = this._parseRealNumber(e, t);
      if (null === n) return null;
      if ("" === r) return n;
      const i = r[0];
      if ("@" == i) {
        const [t, i] = this._parseRealNumber(e, r.substring(1));
        if (null !== t && "" === i) return Complex.from_polar(n, t);
      } else if ("+" == i || "-" == i) {
        const [t, i] = this._parseRealNumber(e, r);
        if (null !== t && i.match(/^[iI]$/)) return new Complex(n, t);
      }
      return null;
    }
    _parseRealNumber(e, t) {
      if ("" === t) return [null, t];
      const n = t.match(/^(\+|-)(inf.0|nan.0)/);
      if (n) {
        return [
          ("inf.0" == n[2] ? 1 / 0 : NaN) * ("+" == n[1] ? 1 : -1),
      ...
      if (
        (r.match(/^\+/)
          ? (r = r.substring(1))
          : r.match(/^\-/) && ((r = r.substring(1)), (i = -1)),
        10 == e && "." == r[0])
      ) {
        const e = t.match(/^\.(\d+)([eE][+-]?\d+)?/);
        return e
          ? [parseFloat("0" + e[0]), t.substring(e[0].length)]
          : [null, t];
      }
      let a = 0;
      const s = r.match(DIGITS[e]);
      if (!s) return [null, t];
      if (
        ...
        r = r.substring(1);
        const n = r.match(DIGITS[e]);
        if (n) {
          r = r.substring(n[0].length);
          const t = parseInt(n[0], e);
          return [new Rational(a, t), r];
        }
        return [null, t];
      }
      if (10 == e) {
        const e = t.match(/^[+-]?(\d+\.\d*|\.?\d+)([eE][+-]?\d+)?/);
        if (e) return [parseFloat(e[0]), t.substring(e[0].length)];
      }
      return [null, t];
    }
    _parseDatumLabel(e) {
      ...
      if (t) {
        ...
        if ("=" == t[2]) {
          ...
          return (this.labelledData[n] = e), e;
        }
        if (this.labelledData.hasOwnProperty(n)) return this.labelledData[n];
        throw new BiwaError("undefined datum reference", e);
      }
      throw new BiwaError("[BUG] not a datum label", e);
    }
    _parseList() {
      const e = this.i,
        t = this.txt[this.i];
    ...
    _parseDecimalNumberOrIdentifier(e) {
      if ("" === e) throw new Bug("empty string given");
      const t = this._parseComplexNumber(10, e);
      return null === t ? Sym(this.foldCase ? e.toLowerCase() : e) : t;
    }
    rest(e = 0) {
  ...
  const check_arity = function (e, t, n, r) {
    ...
    assert_between = make_assert(function (e, t, n, r) {
      if ("number" != typeof t || t != Math.round(t))
        throw new BiwaError(e + ": number required, but got " + to_write(t));
      if (t < n || r < t)
        throw new BiwaError(
          e +
  ...
  class Values {
    ...
    to_write() {
      return "#<Values " + this.content.map(to_write).join(" ") + ">";
    }
  }
  const Console = {};
  ...
  const json2sexp = function (e) {
    switch (!0) {
      ...
      case "object" == typeof e:
        var t = nil;
        for (const n in e) t = new Pair(new Pair(n, json2sexp(e[n])), t);
        return t;
      default:
        throw new Error(
  ...
  var macroexpand_1 = function (e) {
    if (e instanceof Pair) {
      if (
        ...
        throw new Error("macroexpand-1: `" + to_write(e) + "' is not a macro");
  ...
  var assert_regexp = function (e, t) {
    if (!(e instanceof RegExp))
      throw new Error(t + ": regexp required, but got " + to_write(e));
  };
  ...
  define_console_func("debug"),
    ...
    define_syntax("cond", function (e) {
      ...
      if (!(t instanceof Pair) || t === nil)
        throw new BiwaError(
          "malformed cond: cond needs list but got " + write_shared(t)
        );
      var n = null;
      return (
        t
          ...
          .forEach(function (e) {
            if (!(e instanceof Pair))
              throw new BiwaError("bad clause in cond: " + write_shared(e));
            if (e.car === Sym("else")) {
              if (null !== n)
                throw new BiwaError(
    ...
    define_syntax("let", function (e) {
      ...
      if (!(n instanceof Pair) && n != nil)
        throw new BiwaError(
          "let: need a pair for bindings: got " + to_write(n)
        );
      for (var i = nil, a = nil, s = n; s instanceof Pair; s = s.cdr) {
        if (!(s.car instanceof Pair))
          throw new BiwaError(
            "let: need a pair for bindings: got " + to_write(s.car)
          );
    ...
    define_syntax("let*", function (e) {
      ...
      if (!(t instanceof Pair))
        throw new BiwaError(
          "let*: need a pair for bindings: got " + to_write(t)
        );
      var r = null;
      return (
        t
  ...
  var expand_letrec_star = function (e) {
    ...
    if (!(t instanceof Pair))
      throw new BiwaError(
        "letrec*: need a pair for bindings: got " + to_write(t)
      );
    var r = n;
    t.to_array()
      .reverse()
  ...
  define_syntax("letrec", expand_letrec_star),
    ...
    define_libfunc("exact?", 1, 1, function (e) {
      return !1;
    }),
    define_libfunc("inexact?", 1, 1, function (e) {
      return isNumber(e[0]);
    }),
  ...
  define_libfunc("div-and-mod", 2, 2, function (e) {
    return (
      assert_number(e[0]),
      assert_number(e[1]),
      new Values([div(e[0], e[1]), mod(e[0], e[1])])
    );
  }),
    ...
    define_libfunc("div0-and-mod0", 2, 2, function (e) {
      return (
        assert_number(e[0]),
        assert_number(e[1]),
        new Values([div0(e[0], e[1]), mod0(e[0], e[1])])
      );
    }),
  ...
  define_libfunc("truncate/", 2, 2, function (e) {
    return (
      assert_number(e[0]),
      assert_number(e[1]),
      new Values([truncate_q(e[0], e[1]), truncate_r(e[0], e[1])])
    );
  }),
  ...
  define_libfunc(
    ...
    define_libfunc("values", 0, null, function (e) {
      return 1 == e.length ? e[0] : new Values(e);
    }),
    define_libfunc("call-with-values", 2, 2, function (e) {
      ...
      return (
        ...
        new Call(t, [], function (e) {
          var t = e[0];
          return new Call(n, t instanceof Values ? t.content : [t]);
        })
      );
    }),
  ...
  const expandQuasiquote = function (e, t) {
      if (e instanceof Pair) {
        if (e.car === Sym("quasiquote"))
          return List(
            Sym("cons"),
            List(Sym("quote"), Sym("quasiquote")),
            expandQuasiquote(e.cdr, t + 1)
          );
        if (e.car === Sym("unquote") || e.car === Sym("unquote-splicing")) {
          if (t > 0)
            return List(
              Sym("cons"),
              List(Sym("quote"), e.car),
              expandQuasiquote(e.cdr, t - 1)
            );
          if (
            e.car === Sym("unquote") &&
            e.cdr instanceof Pair &&
            e.cdr.cdr === nil
          )
            return e.cdr.car;
        ...
        return e.cdr === nil
          ? expandQqList(e.car, t)
          : List(
              Sym("append"),
              expandQqList(e.car, t),
              expandQuasiquote(e.cdr, t)
            );
      }
      if (e instanceof Array) {
        const n = array_to_list(e);
        return List(
          Sym("list->vector"),
          List(
            Sym("append"),
            expandQqList(n.car, t),
            expandQuasiquote(n.cdr, t)
          )
        );
      }
      return List(Sym("quote"), e);
    },
    expandQqList = function (e, t) {
      if (e instanceof Pair)
        return e.car === Sym("quasiquote")
          ? List(
              Sym("list"),
              List(
                Sym("cons"),
                List(Sym("quasiquote"), e.car),
                expandQuasiquote(e.cdr, t + 1)
              )
            )
          : e.car === Sym("unquote") || e.car === Sym("unquote-splicing")
          ? t > 0
            ? List(
                Sym("list"),
                List(
      ...
      return List(Sym("quote"), List(e));
    };
  define_syntax("quasiquote", function (e) {
    return expandQuasiquote(e.cdr.car, 0);
  }),
  ...
  define_libfunc(
    ...
    define_libfunc("partition", 2, 2, function (e) {
      ...
      return Call.foreach(n, {
        ...
        finish: function () {
          return new Values([array_to_list(r), array_to_list(i)]);
        },
      });
    }),
      ...
      return (
        ...
        Call.foreach(n, {
          call: function (e) {
            ...
            throw new BiwaError(
              "ass*: pair required but got " + to_write(e.car)
            );
          },
          result: function (e, t) {
            if (e) return t.car;
      ...
      return (
        ...
        Call.foreach(i, {
          call: function (n) {
            if (!isPair(n.car))
              throw new BiwaError(
                e + ": pair required but got " + to_write(n.car)
              );
  ...
  define_libfunc("assoc", 2, 2, make_assoc("assoc", "equal?")),
    ...
    define_syntax("case-lambda", function (e) {
      ...
      return (
        t.reverse().forEach(function (e) {
          if (!isPair(e))
            throw new BiwaError(
              "case-lambda: clause must be a pair: " + to_write(e)
            );
          var t = e.car,
            i = e.cdr;
          if (t === nil)
            ...
            if (!isSymbol(t))
              throw new BiwaError(
                "case-lambda: invalid formals: " + to_write(t)
              );
    ...
    define_syntax("define-record-type", function (e) {
      ...
      n.to_array().forEach(function (e) {
        switch (e.car) {
          ...
          default:
            throw new BiwaError(
              "define-record-type: unknown clause `" + to_write(e.car) + "'"
            );
        }
      }),
        s &&
    ...
    define_libfunc("record-mutator", 2, 2, function (e) {
      ...
      return function (e) {
        ...
        assert_record(r),
          assert(
            r.rtd === t,
            a + ": " + to_write(r) + " is not a " + t.name.name
          ),
          assert(
            !r.rtd.sealed,
    ...
    define_libfunc("raise", 1, 1, function (e) {
      throw new UserError(to_write(e[0]));
    }),
    ...
    define_libfunc("put-datum", 2, 2, function (e) {
      return assert_port(e[0]), e[0].put_string(to_write(e[1])), undef;
    }),
    ...
    define_libfunc("write", 1, 2, function (e) {
      var t = e[1] || Port.current_output;
      return assert_port(t), t.put_string(to_write(e[0])), undef;
    }),
  ...
  define_libfunc("hashtable-ref", 3, 3, function (e) {
    ...
    define_libfunc("hashtable-entries", 1, 1, function (e) {
      return assert_hashtable(e[0]), new Values([e[0].keys(), e[0].values()]);
    }),
      ...
      define_syntax(t, function (e) {
        ...
        return (
          ...
          assert(
            ...
            n.name + " is not included in the universe: " + to_write(i.members),
            t
          ),
          List(Sym("quote"), n)
        );
    ...
    define_libfunc("eval", 1, 1, function (e, t) {
      var n = e[0];
      return new Interpreter(t).evaluate(to_write(n));
    }),
    define_syntax("delay", function (e) {
      if (e.cdr === nil) throw new BiwaError("malformed delay: no argument");
      if (e.cdr.cdr !== nil)
        throw new BiwaError(
          "malformed delay: too many arguments: " + write_shared(e)
        );
      var t = e.cdr.car;
      return new Pair(
    ...
    define_syntax("delay-force", function (e) {
      ...
      if (e.cdr.cdr !== nil)
        throw new BiwaError(
          "malformed delay-force: too many arguments: " + write_shared(e)
        );
      var t = e.cdr.car;
      return new Pair(
        Sym(" procedure->promise"),
      ...
      var r = n
        .replace(/~[as]/g, function (t) {
          return (
            ...
            "~a" == t ? to_display(e.shift()) : to_write(e.shift())
          );
        })
        .replace(/~%/, "\n")
        .replace(/~~/, "~");
  ...
  class Dumper {
    ...
    dump_closure(e) {
      ...
      return [
        ...
        this.dump_obj(e.freevars),
        " <span class='dump_closure'>dotpos :</span> ",
        e.dotpos,
        " <span class='dump_closure'>expected_args :</span> ",
        e.expected_args,
        " <span class='dump_closure'>body :</span> ",
        truncate(this.dump_obj(r), 100),
      ].join("");
    }
    dump_obj(e) {
